    ...
    <div class="modal" id="signup-modal">
        <div class="modal-content">
            ...
            <form  action="data.jsp" method="get"  ACACaaid="signup" onsubmit="return validateForm()">
                ...
                <small id="username-error">Username must be between 3 and 25 characters,1 number and 1 special character.</small>
            ...
            <p class="switch-form">
                Have an account? <a href="login" onclick="openModal('login')">Sign In</a>
            </p>
        </div>
    </div>
    ...
    <div class="modal" id="login-modal">
        <div class="modal-content">
           ...
           <form id="login" action="login.jsp" method="post" onsubmit="return validateLoginForm()">
            ...
            <p class="switch-form">
                Don't have an account? <a href="signup" onclick="openModal('signup')">Sign Up</a>
            </p>
        </div>
    </div>
